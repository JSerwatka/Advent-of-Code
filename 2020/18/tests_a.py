...
generate_new_equation = __import__("18a").generate_new_equation
...
class Test(unittest.TestCase):
    def test_1(self):
        ...
        self.assertEqual(eval(new_equation), 71)
    ...
    def test_3(self):
        ...
        equ = "2 * 3 + (4 * 5)"
        new_equation = generate_new_equation(equ)
        self.assertEqual(eval(new_equation), 26)

    def test_4(self):
        """ Fourth test equation """
        equ = "5 + (8 * 3 + 9 + 3 * 4 * 3)"
        new_equation = generate_new_equation(equ)
        self.assertEqual(eval(new_equation), 437)

    def test_5(self):
        """ Fifth test equation """
        equ = "5 * 9 * (7 * 3 * 3 + 9 * 3 + (8 + 6 * 4))"
        new_equation = generate_new_equation(equ)
        self.assertEqual(eval(new_equation), 12240)

    def test_6(self):
        """ Sixth test equation """
        equ = "((2 + 4 * 9) * (6 + 9 * 8 + 6) + 6) + 2 + 4 * 2"
        new_equation = generate_new_equation(equ)
        self.assertEqual(eval(new_equation), 13632)
